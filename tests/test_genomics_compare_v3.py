...
def test_prev_by_location_2_2_with_mutations():
    ...
    assert endpoints._deep_compare(result['results']['(BA.2) AND (S:D614G)'], result_v3['results']['(BA.2) AND (S:D614G)'])
...
def test_prev_by_location_2_2_with_mutations_1():
    ...
    url = 'prevalence-by-location?pangolin_lineage=BA.2&mutations=S:D614G AND S:R21T&location_id=USA'
    result = endpoints._get_endpoint(url)
    result = result.json()
    ...
    assert endpoints._deep_compare(result['results']['(BA.2) AND (S:D614G AND S:R21T)'], result_v3['results']['(BA.2) AND (S:D614G AND S:R21T)'])
...
def test_prev_by_location_2_3():
    ...
    assert endpoints._deep_compare(result['results']['BA.1'], result_v3['results']['(BA.1)']) == True
    assert endpoints._deep_compare(result['results']['BA.2'], result_v3['results']['(BA.2)']) == True
...
def test_prev_by_location_2_4_1():
    # WARNING: The key in the result was changed adding parenthesis.
    # Ex: from 'BA.1' to '(BA.1)'
    url = 'prevalence-by-location?pangolin_lineage=BA.1,BA.2&min_date=2020-07-01&max_date=2022-07-02'
    result = endpoints._get_endpoint(url)
    result = result.json()
...
def test_prev_by_location_3():
    ...
    assert endpoints._deep_compare(result['results']['AY.1'], result_v3['results']['lineages:AY.1']) == True
...
def test_prev_by_location_3_with_mutations():
    ...
    assert endpoints._deep_compare(result['results']['(AY.1) AND (S:E484K)'], result_v3['results']['lineages:AY.1 AND mutations:S:E484K']) == True

def test_prev_by_location_3_1():
    # WARNING: This is a new functionallity.
    # Now it's possible to create a list of logical queries
    # Ex: lineages:AY.1,lineages:AY.2
    url = 'prevalence-by-location?pangolin_lineage=AY.1,AY.2&min_date=2020-07-01&max_date=2023-07-02'
    result = endpoints._get_endpoint(url)
    result = result.json()
    ...
    assert endpoints._deep_compare(result['results']['AY.1'], result_v3['results']['lineages:AY.1']) == True
    assert endpoints._deep_compare(result['results']['AY.2'], result_v3['results']['lineages:AY.2']) == True
...
def test_prev_by_location_3_1_with_mutations():
    ...
    assert endpoints._deep_compare(result['results']['(AY.1) AND (S:E484K)'], result_v3['results']['lineages:AY.1 AND mutations:S:E484K']) == True
    assert endpoints._deep_compare(result['results']['(AY.2) AND (S:E484K)'], result_v3['results']['lineages:AY.2 AND mutations:S:E484K']) == True
...
def test_heavy_query():
    ...
    for lineage in pangolin_lineages.split(','):
        assert endpoints._deep_compare(result['results'][lineage], result_v3['results']['(' + lineage + ')']) == True
